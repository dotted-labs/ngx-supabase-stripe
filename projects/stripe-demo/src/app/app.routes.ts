...
export const routes: Routes = [
  ...
  },
  {
    path: 'signup',
    loadComponent: () =>
      import('./pages/auth/signup-page.component').then((m) => m.SignupPageComponent),
    canActivate: [unauthGuard],
  },
  {
    path: '',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'result',
        loadComponent: () =>
          import('./pages/subscriptions/result/subscriptions-result.component').then(
            (m) => m.SubscriptionsResultComponent,
          ),
      },
    ],
  },
  ...
  },
  {
    path: 'payouts',
    loadComponent: () =>
      import('./pages/payouts/payouts.component').then((m) => m.PayoutsComponent),
  },
  {
    path: '**',
    redirectTo: '',
